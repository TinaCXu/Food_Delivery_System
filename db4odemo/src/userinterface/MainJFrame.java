...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if(ua == null){
            JOptionPane.showMessageDialog(this, "The user name or password is not correct.");
            return;
        }else{
            JPanel roleWorkArea = ua.getRole().createWorkArea(container, ua, system);
            container.add("roleWorkArea",roleWorkArea);
