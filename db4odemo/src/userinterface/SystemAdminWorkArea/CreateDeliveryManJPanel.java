...
public class CreateDeliveryManJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {comboRest, txtAcc, txtName, txtPassword});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {comboRest, txtAcc, txtName, txtPassword});
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(txtName.getText().isBlank() || txtAcc.getText().isBlank() || txtPassword.getText().isBlank() 
                || comboRest.getSelectedItem() == null){
        ...
        Role newRole = new DeliverManRole();
        Employee delivery = ecosystem.getEmployeeDirectory().createEmployee(name,newRole,ecosystem);
        UserAccount deliveryAcc = ecosystem.getUserAccountDirectory().createUserAccount(account, password, delivery, newRole);
        
        DeliveryMan dm = ecosystem.getDeliveryManDirectory().addDeliveryMan(name,delivery);
        dm.setRestaurant(selectedR);
        
        JOptionPane.showMessageDialog(this, "Create delivery man successfully.");
        back();
