...
public class CreateCustomerJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Role newRole = new CustomerRole();
        Employee customer = ecosystem.getEmployeeDirectory().createEmployee(name,newRole,ecosystem);
        UserAccount customerAcc = ecosystem.getUserAccountDirectory().createUserAccount(account, password, customer, newRole);
        
        Customer c = ecosystem.getCustomerDirectory().addCustomer(name, customer);
